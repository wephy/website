        ...
        initThree() {
            ...
            const updateAttractors = () => {
                ...
                for (let i = 0; i < n; i++) {
                    ...
                    vertices[i].push(startPoints[i].x, startPoints[i].y, startPoints[i].z);
                    ...
                    geometries[i].setAttribute('position', new THREE.BufferAttribute(new Float32Array(vertices[i]), 3));
            ...
            const animate = () => {
                ...
                // camera.lookAt(- window.innerWidth / 50 + 0, -80, window.innerWidth / 50);
